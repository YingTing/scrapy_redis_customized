...
# NOTE: to use this settings, two environment variabl must be set
#    export SCRAPY_SETTINGS_MODULE=product_spider.settings_dev
#    export PYTHONPATH=$PYTHONPATH:path-to/search_spider/product_spider
...
DUPEFILTER_REDIS_URL_TTL_SECS = 86400*3
